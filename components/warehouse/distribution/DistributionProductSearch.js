      ...
      <div className={`rounded-lg shadow p-4 mb-4 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="relative">
          ...
          <div className="absolute left-3 top-2.5">
            ...
            {searchTerm ? (
              <div className={`flex-1 rounded-lg shadow overflow-hidden ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                ...
                <div className="divide-y max-h-[60vh] overflow-y-auto styled-scrollbar">
                  ...
                  {!loading && products.length === 0 && (
                    <div className="p-4 text-center text-gray-500">
                      {searchTerm ? 'Produk tidak ditemukan.' : 'Ketik untuk mencari produk di gudang.'}
                    </div>
                  )}
                </div>
              </div>
            ) : (
              <div className={`flex-1 rounded-lg shadow overflow-hidden flex items-center justify-center p-8 text-center ${darkMode ? 'bg-gray-800 text-gray-400' : 'bg-white text-gray-500'}`}>
