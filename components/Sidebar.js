...
const Sidebar = ({ children }) => {
  ...
  const allMenuItems = [
    ...
    { title: "Hapus Data Toko", href: "/manager/delete-store-data", icon: PackageX, type: 'item', roles: ['MANAGER'] },
    ...
    { title: "Master", type: 'heading', roles: ['WAREHOUSE'] },
    ...
    { title: "Notifikasi Stok", href: "/warehouse/low-stock-notifications", icon: Package, type: 'item', roles: ['WAREHOUSE'] },
    { title: "Laporan", type: 'heading', roles: ['WAREHOUSE'] },
    { title: "Laporan Lanjutan", href: "/warehouse/reports/advanced", icon: BarChart3, type: 'item', roles: ['WAREHOUSE'] },
  ...
  const sidebarWidthClass = isCollapsed ? 'w-16' : 'w-64'; // Expanded width: 64px collapsed, 256px expanded
  const mainContentLeftMargin = isMobile ? 'ml-0' : (isCollapsed ? 'ml-16' : 'ml-64'); // Dynamic left margin adjusted to match sidebar width
