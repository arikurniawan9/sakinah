// app/api/warehouse/activity-logs/route.js
...
export async function GET(request) {
  try {
    ...
    const entity = url.searchParams.get('entity') || 'WAREHOUSE'; // Default filter untuk entitas gudang
    ...
    if (entity) filters.entity = entity; // Filter untuk entitas gudang
    ...
    console.error('Error fetching warehouse activity logs:', error);
